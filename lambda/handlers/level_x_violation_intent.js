...
const violationStrings = {
    ...
    Writing 'prongle' up and down the hallways, 
    ...
    Being off-limits,
    Being non-compliant,
    disparaging the name of Glenisson de Oliveira, P H D,
    ...
    Harassing someone.`,
    4: `Level four violations include Being late to curfew by 45 or more minutes, Violating PDA policy,
    ...
    Fighting,
    Interacting with U N T students in any capacity, 
    ...
    5: `Level five violations include Possessing and/or using alcohol or illegal drugs or drug paraphernalia,
